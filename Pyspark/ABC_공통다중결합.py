...
A_B = spark.read.csv('ABC_공통다중결합.csv', header=True, inferSchema=True)
...
final_result = result_A.join(result_B, result_A . B_id_a == result_B . id_b , how="outer")
final_result = final_result.join(result_C, final_result . C_id_a == result_C . id_c, how="left")
# 결과 확인
